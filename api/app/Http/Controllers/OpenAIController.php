...
class OpenAIController extends Controller
{
    ...
    public function generateReview(Request $request)
    {
        ...
        $prompt = "write a good review with emojis in less than 50 words for an " . $restaurant_theme . " " . $restaurant_type . " named " . $restaurant_name . ". Its main highlights are " . $restaurant_highlights . ". Their main dishes are " . $restaurant_main_dishes . ".";
